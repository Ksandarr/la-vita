...
const VillaDetails = () => {
  const { t } = useLanguage()
  return (
    <section className="villa-details section" id="details">
      <div className="container">
        {/* Introduction Section */}
        <div className="villa-intro">
          <div className="intro-content">
            <h2 className="section-title">{t('experienceLuxury')}</h2>
            <p className="intro-description">
              {t('villaDetailsDescription')}
            </p>
            <div className="intro-highlights">
              <div className="highlight">
                ...
                <div>
                  <h4>{t('clifftopLocation')}</h4>
                  <p>{t('clifftopLocationDesc')}</p>
                </div>
              </div>
              <div className="highlight">
                <div className="highlight-icon">
                ...
                <div>
                  <h4>{t('premiumAmenities')}</h4>
                  <p>{t('premiumAmenitiesDesc')}</p>
                </div>
              </div>
              <div className="highlight">
                <div className="highlight-icon">
                ...
                <div>
                  <h4>{t('exclusiveExperience')}</h4>
                  <p>{t('exclusiveExperienceDesc')}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Quick Details Grid */}
        <div className="villa-quick-details">
          <div className="detail-card">
            <div className="detail-icon">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M20 9V7C20 5.89543 19.1046 5 18 5H6C4.89543 5 4 5.89543 4 7V9" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <rect x="2" y="9" width="20" height="11" rx="2" stroke="currentColor" strokeWidth="2"/>
                <path d="M12 15H12.01" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
            <div className="detail-info">
              <h3>{t('bedroomsDetail')}</h3>
              <p>{t('bedroomsDetailDesc')}</p>
            </div>
          </div>
          ...
          <div className="detail-card">
            <div className="detail-icon">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9 6L20 6C20.5523 6 21 6.44772 21 7L21 20C21 20.5523 20.5523 21 20 21L4 21C3.44772 21 3 20.5523 3 20L3 7C3 6.44772 3.44772 6 4 6L6 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <rect x="6" y="2" width="6" height="8" rx="1" stroke="currentColor" strokeWidth="2"/>
              </svg>
            </div>
            <div className="detail-info">
              <h3>{t('bathroomsDetail')}</h3>
              <p>{t('bathroomsDetailDesc')}</p>
            </div>
          </div>
          ...
          <div className="detail-card">
            ...
            <div className="detail-info">
              <h3>{t('guestsDetail')}</h3>
              <p>{t('guestsDetailDesc')}</p>
            </div>
          </div>
          ...
          <div className="detail-card">
            ...
            <div className="detail-info">
              <h3>{t('conciergeDetail')}</h3>
              <p>{t('conciergeDetailDesc')}</p>
            </div>
          </div>
        </div>
        ...
        <div className="villa-pricing">
          <div className="pricing-main">
            <div className="price-display">
              ...
              <span className="period">{t('perNight')}</span>
            </div>
